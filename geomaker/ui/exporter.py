...
class Ui_Exporter(object):
    def setupUi(self, Exporter):
        ...
        self.gridLayout_4.addWidget(self.colormaps, 7, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.zero_sea_level, 10, 1, 1, 2)
        self.coordinates = QtWidgets.QComboBox(self.widget_2)
        self.coordinates.setObjectName("coordinates")
        self.gridLayout_4.addWidget(self.coordinates, 3, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.widget_3, 14, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.textures, 12, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.colormap_preview, 8, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.resolution, 5, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.widget_4, 6, 1, 1, 2)
        self.invertmap = QtWidgets.QCheckBox(self.widget_2)
        self.invertmap.setObjectName("invertmap")
        self.gridLayout_4.addWidget(self.invertmap, 9, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.widget_8, 13, 0, 1, 3)
